...
class PouetRequest_Prod_AddLink extends PouetRequestBase
{
    ...
    {
        return "add a new extra link to a prod";
    }
...
class PouetRequest_Prod_ChangeLink extends PouetRequestBase
{
    ...
    public static function Describe()
    {
        return "change an existing extra link";
    }
...
class PouetRequest_Prod_RemoveLink extends PouetRequestBase
{
    ...
    public static function Describe()
    {
        return "remove an existing extra link";
    }
...
class PouetRequest_Prod_AddCredit extends PouetRequestBase
{
    ...
    public static function Describe()
    {
        return "add a new credit to a prod";
    }
...
class PouetRequest_Prod_ChangeCredit extends PouetRequestBase
{
    ...
    public static function Describe()
    {
        return "change an existing credit";
    }
...
class PouetRequest_Prod_RemoveCredit extends PouetRequestBase
{
    ...
    public static function Describe()
    {
        return "remove an existing credit";
    }
...
class PouetRequest_Prod_ChangeInfo extends PouetRequestBase
{
    ...
    public static function Describe()
    {
        return "change prod info";
    }

    public static function ProdToArray($prod)
    {
    ...
    public static function GetFields($data, &$fields, &$js)
    {
        ...
        $yearsFuture = array("");
        for ($x = date("Y") + 2; $x >= POUET_EARLIEST_YEAR; $x--) {
            $yearsFuture[$x] = $x;
        }
    ...
    public static function Process($itemID, $reqData)
    {
        ...
        foreach ($reqData as $k => $v) {
            switch ($k) {
                case "partyID":    $sql["party"] = nullify($v);
                    break;
                case "partyYear":  $sql["party_year"] = $v;
                    break;
                case "partyCompo": $sql["party_compo"] = nullify($v);
                    break;
                case "partyRank":  $sql["party_place"] = nullify($v);
                    break;
                case "type":       $sql["type"] = implode(",", $v);
                    break;
                case "platform":   break; // deal with this underneath
                case "demozooID":  $sql["demozoo"] = (int)$v;
                    break;
                case "csdbID":     $sql["csdb"] = (int)$v;
                    break;
                case "invitationParty": $sql["invitation"] = $v;
                    break;
                case "group1":     $sql["group1"] = nullify($v);
                    break;
                case "group2":     $sql["group2"] = nullify($v);
                    break;
                case "group3":     $sql["group3"] = nullify($v);
                    break;
                default:
                    $sql[$k] = $v;
            }
