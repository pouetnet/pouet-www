...
class PouetBoxEditConnectionsBase extends PouetBox
{
    ...
    public function RenderNormalRow($row)
    {
    }
    public function RenderNormalRowEnd($row)
    {
        echo "<td>";
    ...
    public function RenderDeleteRowEnd($row)
    {
        if (!$this->allowDelete) {
            return;
        }
    ...
    public function RenderEditRowEnd($row = null)
    {
        echo "<td>";
        $csrf = new CSRFProtect();
        $csrf->PrintToken();
    ...
    public function RenderBody()
    {
        ...
        foreach ($this->data as $row) {
            ...
            } elseif (@$_GET["del" . static::$slug] == $row->id && $this->allowDelete) {
    ...
    public function RenderPartialResponse()
    {
