...
class PouetBoxUserMain extends PouetBox
{
    ...
    public function __construct($id, $show)
    {
        parent::__construct();
    ...
    public function AddRow($field, $value, $allowHTML = false)
    {
        $s = "";
        if ($value) {
            echo "<li>\n";
    ...
    public function GetLogosAdded($limit = null)
    {
        $s = new BM_Query();
        $s->AddTable("logos");
    ...
    public function GetProdsAdded($limit = null)
    {
    ...
    public function GetGroupsAdded($limit = null)
    {
    ...
    public function GetPartiesAdded($limit = null)
    {
    ...
    public function GetScreenshotsAdded($limit = null)
    {
        $s = new BM_Query("prods");
    ...
    public function GetNFOsAdded($limit = null)
    {
        $s = new BM_Query("prods");
    ...
    public function GetCredits($limit = null)
    {
        $s = new BM_Query();
        $s->AddTable("credits");
    ...
    public function GetFirstCommentsAdded($limit = null)
    {
        $s = new BM_Query("prods");
    ...
    public function GetThumbAgreers($limit = null, $thumb = 1)
    {
        $s = new BM_Query("");
    ...
    public function GetBBSTopics($limit = null)
    {
        $s = new BM_Query();
    ...
    public function GetBBSPosts($limit = null)
    {
        $s = new BM_Query();
    ...
    public function GetLists($limit = null)
    {
        $s = new BM_Query();
        $s->AddTable("lists");
    ...
    public function GetModRequests($limit = null)
    {
        $s = new BM_Query();
    ...
    public function GetDemoblog($page)
    {
        $s = new BM_Query();
        $s->AddTable("comments");
        $s->AddField("count(*) as c");
        ...
        if (@$_GET["nothumbsup"]) {
            $s->AddWhere("comments.rating != 1");
        }
        if (@$_GET["nopiggies"]) {
            $s->AddWhere("comments.rating != 0");
        }
        if (@$_GET["nothumbsdown"]) {
            $s->AddWhere("comments.rating != -1");
        }
