...
function PouetAdmin_recacheFrontPagePartial_Form()
{
    ...
    foreach (glob("cache/*") as $v) {
        echo "<li><input type='checkbox' name='deleteCache["._html(basename($v))."]' id='"._html($v)."'/> <label for='"._html($v)."'>"._html($v)."</label></li>\n";
    }
    echo "</ul>";
}
...
class PouetBoxAdmin extends PouetBox
{
    ...
    public function Render()
    {
        ...
        if ($currentUser->IsModerator()) {
            ...
            echo "  <li><a href='admin_localnews.php'>edit local news</a></li>";
        }
        echo "</ul>\n";
        echo "</div>\n";
    }
