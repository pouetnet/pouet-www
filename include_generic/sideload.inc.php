...
class Sideload
{
    ...
    public function RequestCURL($url, $method = "GET", $contentArray = array(), $headerArray = array())
    {
        $curl = curl_init();
    ...
    public function RequestFGC($url, $method = "GET", $contentArray = array(), $headerArray = array())
    {
        $opt = array();
        $param = array();
